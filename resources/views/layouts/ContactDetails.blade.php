...
<div class="w-full max-w-2xl lg:max-w-5xl xl:max-w-6xl 
                ...
                p-8 md:p-12 
                mx-auto -mt-[1px]"> 
        <h2 class="font-palatino sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#850038] mb-6 text-center">
                Contact Details
        </h2>
            <!-- Form Content -->
    <form class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
        ...
        <div class="relative w-full">
                ...
                <p class="text-[12px] text-black-500 mt-1">Street Address</p>
        </div>
          <div class="relative w-full">
            <div class="relative w-full">
        ...
        <div class="relative w-full">
           ...
           <div class="col-span-1 md:col-span-2">
            ...
            <div class="md:col-span-1 flex flex-col w-full">
                <label for="streetaddressline1" class="font-medium">
             ...
             <div class="md:col-span-1 flex flex-col w-full">
                <label for="streetaddressline2" class="font-medium">
            ...
            <div class="relative w-full">
                ...
                <button 
                type="submit"
                class="w-full sm:w-auto px-8 py-3 bg-[#850038] text-white font-semibold rounded-[12px] 
